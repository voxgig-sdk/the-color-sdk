...
|---|---|---|
| `ts/` | @voxgig-sdk/the-color-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/the-color-sdk \
      --repository voxgig-sdk/the-color-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/the-color-sdk` shows it, and
`npm trust revoke @voxgig-sdk/the-color-sdk --id=<id>` removes it.
