...
from projectname_sdk import TheColorSDK
from projectname_sdk.core.spec import TheColorSpec
from projectname_sdk.core.result import TheColorResult
from projectname_sdk.core.response import TheColorResponse
from projectname_sdk.core.operation import TheColorOperation
from projectname_sdk.core.error import TheColorError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import TheColorBaseFeature
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = TheColorSDK.test(None, None)
        ...
        class TestInitFeature(TheColorBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(TheColorBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = TheColorSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = TheColorSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = TheColorSDK.test(None, setup_opts)
