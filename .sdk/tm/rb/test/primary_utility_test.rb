...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = TheColorOmni.make_runner(TEST_JSON_FILE, TheColorSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : TheColorOmni.errify(err)
    end
