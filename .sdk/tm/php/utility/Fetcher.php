...
// TheColor SDK utility: fetcher

class TheColorFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; TheColorSDK/1.0)';
    ...
    public static function call(TheColorContext $ctx, string $fullurl, array $fetchdef): array
    {
