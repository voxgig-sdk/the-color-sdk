...
class TheColorGraphql
{
    ...
    // equivalent.
    public static function body(TheColorContext $ctx): mixed
    {
    ...
    public static function errors(TheColorContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
