...
// TheColor SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = TheColorOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(TheColorOmni::structfix($now, Struct::undef()))
                        !== json_encode(TheColorOmni::structfix($val, Struct::undef()))) {
