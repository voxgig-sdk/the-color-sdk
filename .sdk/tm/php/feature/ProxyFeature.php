...
class TheColorProxyFeature extends TheColorBaseFeature
{
    ...
    public function init(TheColorContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (TheColorContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
