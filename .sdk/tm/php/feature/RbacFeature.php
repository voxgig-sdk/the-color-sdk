...
class TheColorRbacFeature extends TheColorBaseFeature
{
    ...
    private function _required(TheColorContext $ctx): ?string
    {
    ...
    private function _reject(TheColorContext $ctx, string $required): void
    {
    ...
    private function _track(TheColorContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
