...
class TheColorCacheFeature extends TheColorBaseFeature
{
    ...
    private function _through(TheColorContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
