...
class TheColorTimeoutFeature extends TheColorBaseFeature
{
    ...
    private function _with_timeout(TheColorContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(TheColorContext $_ctx, float $ms): void
    {
        $client = $this->client;
