...
// TheColor SDK clienttrack feature
...
class TheColorClienttrackFeature extends TheColorBaseFeature
{
    ...
    public function PostConstruct(TheColorContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'TheColor-SDK';
