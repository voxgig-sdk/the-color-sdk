...
// TheColor SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class TheColorMakeRequest
{
    public static function call(TheColorContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new TheColorResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new TheColorResponse($fetched);
        } else {
