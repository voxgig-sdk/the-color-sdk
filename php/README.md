...
The PHP SDK for the TheColor API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Idn(null)->load(["id" => "example_id"], null);
...
[$result, $err] = $client->TheColor(null)->load(
    ["id" => "test01"], null
);
