...
The PHP SDK for the TheColor API — an entity-oriented client using PHP conventions.
...
```
php/
├── thecolor_sdk.php          -- Main SDK class
...
The main class (`thecolor_sdk.php`) exports the SDK class
