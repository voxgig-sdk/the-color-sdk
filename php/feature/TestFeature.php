...
// TheColor SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class TheColorTestFeature extends TheColorBaseFeature
{
    ...
    public function init(TheColorContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (TheColorContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (TheColorContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(TheColorContext $ctx, $op, $args): array
    {
