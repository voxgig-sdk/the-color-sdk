...
// TheColor SDK streaming feature
...
class TheColorStreamingFeature extends TheColorBaseFeature
{
    ...
    private function _iterate(TheColorResult $result): \Generator
    {
    ...
    private function _streamable(TheColorContext $ctx): bool
    {
