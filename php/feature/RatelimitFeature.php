...
// TheColor SDK ratelimit feature
...
class TheColorRatelimitFeature extends TheColorBaseFeature
{
    ...
    private function _acquire(TheColorContext $ctx): void
    {
    ...
    private function _track(TheColorContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
