...
class SchemeDirectTest extends TestCase
{
    public function test_direct_list_scheme(): void
    {
        $setup = scheme_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-scheme", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
