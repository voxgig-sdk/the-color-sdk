...
class IdnEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set THECOLOR_TEST_IDN_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function idn_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("THECOLOR_TEST_IDN_ENTID");
