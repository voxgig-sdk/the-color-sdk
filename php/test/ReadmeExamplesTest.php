...
// TheColor SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (TheColorSDK::test)
...
{
    private const SDK_CLASS = 'TheColorSDK';
    ...
    private const SDK_BASE = 'thecolor_sdk';
