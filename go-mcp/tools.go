...
type Args struct {
	Entity string         `json:"entity" jsonschema:"idn | scheme"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.TheColorSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "the-color_list",
		Description: "List records from TheColor. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "the-color_load",
		Description: "Load a single record from TheColor. " +
...
func runOp(client *sdk.TheColorSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.TheColorSDK, name string) (sdk.TheColorEntity, error) {
	switch strings.ToLower(name) {
	case "idn":
		return client.Idn(nil), nil
	case "scheme":
		return client.Scheme(nil), nil
