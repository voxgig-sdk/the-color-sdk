...
describe("SchemeDirect", function()
  it("should direct-list-scheme", function()
    local setup = scheme_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-scheme", setup.live and "live" or "unit")
...
function scheme_direct_setup(mockres)
