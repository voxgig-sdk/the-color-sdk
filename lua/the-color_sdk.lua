...
local TheColorSDK = {}
TheColorSDK.__index = TheColorSDK
...
TheColorSDK._make_feature = _make_feature


function TheColorSDK.new(options)
  local self = setmetatable({}, TheColorSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function TheColorSDK:options_map()
...
function TheColorSDK:get_utility()
  return Utility.copy(self._utility)
end


function TheColorSDK:get_root_ctx()
  return self._rootctx
end


function TheColorSDK:prepare(fetchargs)
...
function TheColorSDK:direct(fetchargs)
...
-- by passing it.
function TheColorSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function TheColorSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "TheColorSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function TheColorSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = TheColorSDK.new(sdkopts)
  sdk.mode = "test"
