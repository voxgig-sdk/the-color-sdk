...
class TheColorTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = TheColorTestRunner.getenv("THE_COLOR_TEST_LIVE")
        override = TheColorTestRunner.getenv("THE_COLOR_TEST_OVERRIDE")
        ...
        explain = TheColorTestRunner.getenv("THE_COLOR_TEST_EXPLAIN")
