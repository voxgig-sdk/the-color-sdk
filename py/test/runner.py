...
class TheColorTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = TheColorTestRunner.getenv("THECOLOR_TEST_LIVE")
        override = TheColorTestRunner.getenv("THECOLOR_TEST_OVERRIDE")
        ...
        explain = TheColorTestRunner.getenv("THECOLOR_TEST_EXPLAIN")
