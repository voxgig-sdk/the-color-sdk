# TheColor SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions TheColorSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both TheColorSDK(...) and TheColorSDK.test(...) become
#      TheColorSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "thecolor_sdk"
_SDK_CLASS = "TheColorSDK"
