...
The Python SDK for the TheColor API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.Idn()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/the-color-sdk/releases)) or
...
```
py/
├── thecolor_sdk.py         -- Main SDK module
