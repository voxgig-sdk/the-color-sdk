...
from thecolor_sdk.core.control import TheColorControl
...
from thecolor_sdk.core.helpers import get_ctx_prop, to_map
...
class TheColorContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(r, TheColorResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, TheColorResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return TheColorError(code, msg, self)
