...
from thecolor_sdk.utility import register

# Load features
from thecolor_sdk.feature.base_feature import TheColorBaseFeature
from thecolor_sdk.features import _has_feature, _make_feature
...
class TheColorSDK:
    ...
    def get_utility(self):
        return TheColorUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("TheColorSDK: graphql: " + str(msg))
            res["graphql"] = errors
