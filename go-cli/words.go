...
func registerSDKWords(r *eng.Registry, client *sdk.TheColorSDK) {
...
func runOp(client *sdk.TheColorSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
