...
(0, node_test_1.describe)('SchemeDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-scheme', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-scheme', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.THE_COLOR_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.TheColorSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['THE_COLOR_TEST_SCHEME_ENTID'];
    ...
    const client = new __1.TheColorSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=SchemeDirect.test.js.map