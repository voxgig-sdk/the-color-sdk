...
type SchemeEntity struct {
	name    string
	client  *core.TheColorSDK
...
func NewSchemeEntity(client *core.TheColorSDK, entopts map[string]any) *SchemeEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SchemeEntity) GetName() string { return e.name }
...
func (e *SchemeEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *SchemeEntity) Deleted() bool {
	return e.deleted
}


func (e *SchemeEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewSchemeEntity(e.client, opts)
}

func (e *SchemeEntity) Data(args ...any) any {
...
func (e *SchemeEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Scheme; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *SchemeEntity) DataTyped(data ...Scheme) Scheme {
	if len(data) > 0 {
		return typedFrom[Scheme](e.Data(asMap(data[0])))
	}
	return typedFrom[Scheme](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Scheme (all fields
// optional at the wire level).
func (e *SchemeEntity) MatchTyped(match ...Scheme) Scheme {
	if len(match) > 0 {
		return typedFrom[Scheme](e.Match(asMap(match[0])))
	}
	return typedFrom[Scheme](e.Match())
}
...
func (e *SchemeEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *SchemeEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *SchemeEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// SchemeListMatch and returns []Scheme. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *SchemeEntity) ListTyped(reqmatch SchemeListMatch, ctrl map[string]any) ([]Scheme, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Scheme](res), nil
}



func (e *SchemeEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *SchemeEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *SchemeEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *SchemeEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
