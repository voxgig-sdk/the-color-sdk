# TheColor Golang SDK Reference

Complete API reference for the TheColor Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *TheColorSDK`
...
#### `Idn(data map[string]any) TheColorEntity`

Create a new `Idn` entity instance. Pass `nil` for no initial data.

#### `Scheme(data map[string]any) TheColorEntity`
