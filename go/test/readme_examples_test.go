...
const testSeed = `map[string]any{"entity": map[string]any{"idn": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "scheme": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
