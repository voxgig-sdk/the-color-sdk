...
func (sdk *TheColorSDK) OptionsMap() map[string]any {
...
func (sdk *TheColorSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *TheColorSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *TheColorSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *TheColorSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *TheColorSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *TheColorSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("TheColorSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *TheColorSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *TheColorSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("TheColorSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
